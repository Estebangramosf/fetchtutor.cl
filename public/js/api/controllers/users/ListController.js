...
var _vue2Filters = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"vue2-filters\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
// Imports requeribles
var UsersList = __webpack_require__(14);
var Paginators = __webpack_require__(62);
...
var Index = new Vue({
  ...
  methods: {
    ...
    navigate: function navigate(page) {
      ...
      this.$http.get('/users/all?page=' + page).then(function (response) {
        // get body json data
    ...
    changeUserOrder: function changeUserOrder() {
    ...
    orderUsers: function orderUsers() {
      this.users = _lodash._.orderBy(this.users, 'name', this.userOrder);
    ...
    shuffle: function shuffle(items) {
      return _lodash._.shuffle(items);
    },
    ...
    fetchUsers: function fetchUsers() {
      ...
      this.$http.get('/users/all').then(function (response) {
        // get body json data
        _this2.users = response.body.data;
        _this2.pagination = response.data;
        _this2.shuffle(_this2.users);
      }, function (response) {
        console.log(response);
        // error callback
      });
...
Component.options.__file = "/var/www/html/dailymodern/FETCHTUTOR/fetchtutor.cl/resources/assets/js/components/paginators/Paginators.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Paginators.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4849bd7c", Component.options)
  } else {
    hotAPI.reload("data-v-4849bd7c", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4849bd7c", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("a032e0bc", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-4849bd7c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Paginators.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-4849bd7c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Paginators.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
